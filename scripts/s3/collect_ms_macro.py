...
hf_url = "https://huggingface.co/datasets/microsoft/ms_marco"
os.environ["S3_DATASET_NAME"] = "ms_marco"
...
def main():
    ...
    try:
        ...
        for i, split_name in enumerate(splits):
            ...
            dataset = load_dataset("microsoft/ms_marco", split_name, trust_remote_code=True)
    ...
    for id, question in tqdm(enumerate(dataset["query"])):
